	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner" style="width: 100%">
			<div class="carousel-item active">
				<img class="d-block w-100" src="resources/images/Curosel-1.jpg" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="resources/images/Curosel-2.jpg" alt="Second slide">
			</div>
		</div>
       ...
       <div class="row">
         <div class="col-md-2 " >
             <div class="list-group mt-4">
                 ...
                 <a href="category?categoryId=0" class="list-group-item list-group-item-actionh active"  style="background-color: #B7402B" ><span class="text-color">All Categories</span></a>
               <%
